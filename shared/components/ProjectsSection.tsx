...
function ProjectsSection() {
  ...
  return (
    <section
      id="projects"
      className="w-full relative pl-6 sm:pl-8 py-16 md:pl-16 md:py-24 lg:pl-20 lg:py-30 border-b-2 sm:border-b-3 border-black dark:border-white flex flex-col gap-8 lg:gap-12"
    >
